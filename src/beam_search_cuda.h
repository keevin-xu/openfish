...
static __global__ void beam_search(
    ...
    // This is asserted host-side before the kernel launch (see decode_cuda.c).
    ...
    // keeping it out of static LDS lowers the kernel's static LDS footprint, raising occupancy / blocks-per-SM.
